...
function krnTrace(msg)
{
   ...
   if (_Trace)
   {
      if (msg === "Idle")
      {
         ...
         if (_OSclock % 75 == 0)  // Check the CPU_CLOCK_INTERVAL in globals.js for an 
...
function krnTrapError(msg)
{
    ...
    //circle
    _DrawingContext.strokeStyle = '#0000FF';
    _DrawingContext.fillStyle = '#FFFF00';
    _DrawingContext.lineWidth = 4;
    _DrawingContext.beginPath();
    _DrawingContext.arc(250,250,50,0*Math.PI,2*Math.PI,true);
    _DrawingContext.closePath();
    _DrawingContext.stroke();
    _DrawingContext.fill();
    
    // Eyes
    _DrawingContext.strokeStyle = '#000000';
    _DrawingContext.fillStyle = '#000000';
    _DrawingContext.beginPath();
    _DrawingContext.arc(230,235,10,0*Math.PI,2*Math.PI,false);
    _DrawingContext.closePath();
    _DrawingContext.stroke();
    _DrawingContext.fill();
    ...
    _DrawingContext.fillStyle = '#000000';
    _DrawingContext.beginPath();
    _DrawingContext.arc(270,235,10,0*Math.PI,2*Math.PI,false);
    _DrawingContext.closePath();
    _DrawingContext.stroke();
    _DrawingContext.fill();
    ...
    _DrawingContext.lineWidth = 2;
    _DrawingContext.beginPath();
    _DrawingContext.arc(250,290,20,-(0.2*Math.PI,0.8*Math.PI),false);
    _DrawingContext.stroke();
    
    //Error Msg and shutdown
    _StdIn.putText(msg);
    krnShutdown();
